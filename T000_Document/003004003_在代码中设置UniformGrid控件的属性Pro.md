...
## 前置知识
> **摘要：** 本文详细讲解了在 WPF 中通过 C# 代码动态设置 `UniformGrid` 控件属性的方法，包括纯代码创建和 XAML 中定义后修改两种典型场景，并附有常用属性速查表及核心注意事项。
...
<Window x:Class="UniformGridCodeDemo.MainWindow"
        xmlns="http://schemas.microsoft.com/winfx/2006/xaml/presentation"
        xmlns:x="http://schemas.microsoft.com/winfx/2006/xaml"
        Title="修改 UniformGrid 属性" Height="300" Width="400">
    <Grid>
...
namespace UniformGridCodeDemo
{
    public partial class MainWindow : Window
    {
        ...
        {
            // 直接用 x:Name 访问，修改属性
            ugDemo.Columns = 2;    // 修改列数为 2
            ugDemo.Rows = 2;       // 修改行数为 2
